...
public class SegurateLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "AGREGAR_USUARIO", "AGREGAR_IP", "ACTIVAR_MONITOREO", 
			"ID", "NUMERO", "LETRA", "DIGITO", "WS"
		};
	}
	...
	public SegurateLexer(CharStream input) {
		super(input);
